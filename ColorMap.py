...
class TerminalColorMap:
  ...
  def colorize(self, string, rgb=None, ansi=None,bg=None):
    ...
    (closestBg,shit) = self.convert(bg)

    return u"\033[38;5;{ansiCode:d}m\033[48;5;{bf:d}m{string:s}\033[0m".format(ansiCode=closestAnsi,bf=closestBg, string=string)
